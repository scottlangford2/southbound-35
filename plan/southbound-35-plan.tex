...
is the first; Williamson County, Comal County, Bexar northside,
and the East Austin / Bastrop edge are the obvious next four. Each
...
This template will be applied, with light adaptation, to at least
four more counties over the next three years:
Williamson (the closest analogue to Hays in growth dynamics);
Comal (water-constrained, Edwards Aquifer dependence);
the Bexar Northside (a different governance pattern --- a single
large city extending into a fragmented exurban edge);
and the Bastrop / Caldwell / Eastern Travis edge (the most
under-studied piece of the corridor).
...
corridor series (Williamson, Comal). Reach 200 email subscribers.
...
\item Draft the first three Williamson County series posts and
review before the cadence date.
